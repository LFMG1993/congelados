...
import { BarChartLine, BoxSeam, CashStack } from 'react-bootstrap-icons';

export type ReportType = 'sales' | 'purchases' | 'sessions';
        ...
        <div className="list-group">
            {reportOptions.map(({ key, label, Icon }) => (
                <a
                    ...
                    onClick={(e) => { e.preventDefault(); onSelectReport(key as ReportType); }}
                >
                    <Icon className="me-2" />
                    {label}
                </a>
